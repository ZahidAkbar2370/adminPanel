			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="#"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a></li>
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="#"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Product</span></a></li>
								<li><a class="submenu" href="#"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Product</span></a></li>

							</ul>	
						</li>


						<li><a href="#"><i class="icon-edit"></i><span class="hidden-tablet"> Sliders</span></a></li>


						<li><a href="#"><i class="icon-list-alt"></i><span class="hidden-tablet"> Social Icons</span></a></li>
